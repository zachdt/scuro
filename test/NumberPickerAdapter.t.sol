...
contract NumberPickerAdapterTest is Test {
    ...
    function setUp() public {
        ...
        engine = new NumberPickerEngine(address(catalog), address(vrfCoordinator));
        adapter = new NumberPickerAdapter(address(settlement), address(catalog), address(engine));
        catalog.registerModule(
            GameCatalog.Module({
                controller: address(adapter),
