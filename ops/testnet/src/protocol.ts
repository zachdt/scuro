...
const DEPLOY_STAGES: DeployStage[] = [
  { name: "core", target: "script/testnet/DeployCore.s.sol:DeployCore" },
  { name: "number-picker", target: "script/testnet/DeployNumberPickerModule.s.sol:DeployNumberPickerModule" },
  { name: "slot", target: "script/testnet/DeploySlotModule.s.sol:DeploySlotModule" },
  { name: "finalize", target: "script/testnet/DeployFinalize.s.sol:DeployFinalize" }
];
...
export async function runNumberPickerSmoke(
  ...
  return runSmokeScript("script/testnet/SmokeNumberPicker.s.sol:SmokeNumberPicker", config, activeManifest, deps);
}
...
export async function runSlotSmoke(
  ...
  return runSmokeScript("script/testnet/SmokeSlot.s.sol:SmokeSlot", config, activeManifest, deps);
}
